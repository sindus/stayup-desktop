import { GitBranch, PlaySquare, Rss, Globe } from "lucide-react";
import type {
  ChangelogItem,
  YoutubeItem,
  YoutubeItemContent,
...
export function UnifiedFeedList({
  ...
  const repoUrlMap = Object.fromEntries(
    repositories.map((r) => [r.repository_id, r.url])
  );
